<template>
  <div>
    ...
    <section class="about-us container py-5 text-center">
      <h2 class="font-weight-bolder mb-3 pb-2">
        ABOUT US
      </h2>
      <p class="h4 pb-2">
        MapleStory Shop
    ...
    <section class="best-seller pt-5 pb-4">
      <div class="container pb-5 text-center">
        <h2 class="font-weight-bolder mb-4 pb-2">
          最受歡迎的商品
        </h2>
    ...
    <section class="comment pt-5">
      <div class="container text-center">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="npc npc1 ml-auto mr-auto mb-3" />
            <div class="h5">
              上班族阿凱
            </div>
            <p
              class="mb-3 mb-md-0"
            >
              在我還沒發現 MapleStory Shop 之前，我下班後還得自己花時間找資料。多虧了這裡有各式各樣的裝備與詳細的介紹，讓我省下許多時間並且購買到想要的裝備。
            </p>
          </div>
          <div class="col-md-4">
            <div class="npc npc2 ml-auto mr-auto mb-3" />
            <div class="h5">
              大學生悠娜
            </div>
          ...
          <div class="col-md-4">
            <div class="npc npc3 ml-auto mr-auto mb-3" />
            <div class="h5">
              高中生奈蘿
            </div>
            <p class="mb-3 mb-md-0">
      ...
      <div class="row justify-content-center no-gutters">
        <div class="col-10 text-center">
          <router-link
            to="/category"
            class="btn btn-maple d-block d-md-inline-block
          py-2 px-md-5 py-md-3 font-weight-bold rounded-0"
          >
            查看所有商品
          </router-link>
        </div>
    ...
    <section class="job-swiper py-5 mt-3 mb-5 text-center">
      ...
      <div class="swiper-container pt-4">
        <div class="swiper-wrapper">
          ...
          >
            <swiper-slide>
              <div class="slide">
                <img
                  src="../assets/images/Job/beginner.jpg"
                  class="img-fluid"
                  alt
                >
              </div>
            ...
            <swiper-slide>
              <div class="slide">
                <img
                  src="../assets/images/Job/sword.png"
                  class="img-fluid"
                  alt
                >
              </div>
            ...
            <swiper-slide>
              <div class="slide">
                <img
                  src="../assets/images/Job/warrior.jpg"
                  class="img-fluid"
                  alt
                >
              </div>
            ...
            <swiper-slide>
              <div class="slide">
                <img
                  src="../assets/images/Job/knight.png"
                  class="img-fluid"
                  alt
                >
              </div>
            ...
            <swiper-slide>
              <div class="slide">
                <img
                  src="../assets/images/Job/thief-male.jpg"
                  class="img-fluid"
                  alt
                >
              </div>
            ...
            <swiper-slide>
              <div class="slide">
                <img
                  src="../assets/images/Job/thief.jpg"
                  class="img-fluid"
                  alt
                >
              </div>
            ...
            <swiper-slide>
              <div class="slide">
                <img
                  src="../assets/images/Job/thief2.png"
                  class="img-fluid"
                  alt
                >
              </div>
            ...
            <swiper-slide>
              <div class="slide">
                <img
                  src="../assets/images/Job/magician.jpg"
                  class="img-fluid"
                  alt
                >
              </div>
            ...
            <swiper-slide>
              <div class="slide">
                <img
                  src="../assets/images/Job/wizard.png"
                  class="img-fluid"
                  alt
                >
              </div>
            ...
            <swiper-slide>
              <div class="slide">
                <img
                  src="../assets/images/Job/archer-male.jpg"
                  class="img-fluid"
                  alt
                >
              </div>
            ...
            <swiper-slide>
              <div class="slide">
                <img
                  src="../assets/images/Job/archer.jpg"
                  class="img-fluid"
                  alt
                >
              </div>
        ...
        <div class="swiper-button-next swp2" />
      </div>
      <div
        slot="pagination"
        class="swiper-pagination swp2"
      />
    </section>
  </div>
</template>
